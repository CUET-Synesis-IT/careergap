...
import { ListChecks, Clock, User, LogOut } from "lucide-react";
      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
        <div className="flex items-center gap-6">
          <Link href="/reviewer/tasks" className="flex items-center gap-2 font-bold tracking-tight">
            ...
            <span>CareerGap</span>
            <span className="rounded bg-indigo-50 px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-indigo-700 dark:bg-indigo-950 dark:text-indigo-300">
              Reviewer
            </span>
          </Link>
