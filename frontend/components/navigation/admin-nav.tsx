    ...
    <header className="sticky top-0 z-30 w-full border-b border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
        <div className="flex items-center gap-6">
          <Link href="/admin/reviewers" className="flex items-center gap-2 font-bold tracking-tight">
            ...
            <span>CareerGap</span>
            <span className="rounded bg-purple-50 px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-purple-700 dark:bg-purple-950 dark:text-purple-300">
              Super Admin
            </span>
          </Link>
