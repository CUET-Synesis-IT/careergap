...
const careers = [
    {
        ...
        description: "Builds server-side applications, APIs, databases, distributed systems, and backend infrastructure.",
        profile: {
            skills: [
    ...
    },
    {
        ...
        description: "Builds responsive, accessible, performant, and interactive web applications.",
        profile: {
            skills: [
                { name: "JavaScript", importance: "HIGH" },
                { name: "TypeScript", importance: "HIGH" },
    ...
    },
    {
        slug: "ai_ml_engineer",
        name: "AI/ML Engineer",
        description: "Builds machine learning systems, AI applications, data pipelines, and model-powered software.",
        profile: {
            skills: [
    ...
    },
    {
        ...
        description: "Builds and maintains deployment pipelines, cloud infrastructure, automation, monitoring, and reliable systems.",
        profile: {
            skills: [
    ...
    },
    {
        slug: "data_engineer",
        name: "Data Engineer",
        description: "Builds data pipelines, data platforms, warehouses, transformation systems, and reliable data infrastructure.",
        profile: {
            skills: [
                { name: "Python", importance: "HIGH" },
                { name: "SQL", importance: "HIGH" },
